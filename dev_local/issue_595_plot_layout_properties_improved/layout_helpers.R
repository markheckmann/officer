...
#' for disambiguation in case layout name is not unique across masters.
#'
...
#' @keywords internal
#' @return A list with the entries index, layout_name, layout_file, master_name, master_file
#' @examples
#' x <- read_pptx()
